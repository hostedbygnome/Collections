...
public class WarAndPeace {
    ...
    /** Выбраны коллекции:
     * LinkedHashMap для хранения слов и количества их повторений в тексте.
     * Выбрана эта коллекция, т. к. итерируемся быстрее, в среднем, в 4 раза, чем по HashMap, за счет ссылок!
     * А сложность вставки все также O(1).
     ...
     * за счет того, что сложность операций poll и offer в эту коллекцию обходится нам в log(10),
    ...
    public static void main(String[] args) {
        final Map<String, Integer> wordsCount = new LinkedHashMap<>();
